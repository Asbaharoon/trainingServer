 ...
 */
public class TrainingSessionManager2 implements ActionObserver{
	...
	public TrainingSessionManager2(WebSocket.Connection connection, TrainingProblemRequest request){

		System.out.println("Instantiated session manager version 2.");

		this.connection = connection;

		this.cti = new CommandsTrainingInterface2(request.getDomainGenerator());
